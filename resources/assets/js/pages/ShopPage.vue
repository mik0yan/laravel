<template>
   <div class="shopSec">
       ...
       <div>
       <b-pagination size="lg" :total-rows="100" v-model="currentPage" :per-page="10" class="pageBar" align="center">
       </b-pagination>
       </div>
   </div>
</template>
